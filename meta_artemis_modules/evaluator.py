...
class MetaArtemisEvaluator:
    ...
    async def _get_or_create_optimisation(self) -> Optional[str]:
        ...
        try:
            ...
            default_optimisation_ids = DEFAULT_PROJECT_OPTIMISATION_IDS.get(self.project_id, [])
            default_optimisation_id = default_optimisation_ids[0] if default_optimisation_ids else None
